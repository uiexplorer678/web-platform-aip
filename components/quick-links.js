  const linksData = [
    ...
    function generateLinkList(containerId, items) {
      ...
      items.forEach(({ linkName, link }) => {
        ...
        div.innerHTML = `
          <a class="quicklink-user-item" href="${link}" target="_blank" rel="noopener noreferrer">
            <div class="quicklink-user-text">
              <div class="quicklink-text-content">${linkName}</div>
            </div>
          </a>
          <div class="quicklink-external-link" onclick="window.open('${link}', '_blank')">
